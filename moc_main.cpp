...
static const char qt_meta_stringdata_ChatDialog[] = {
    "ChatDialog\0\0sendData(QString)\0"
    "gotReturnPressed()\0"
};
...
// SIGNAL 0
void ChatDialog::sendData(QString _t1)
{
...
static const char qt_meta_stringdata_NetSocket[] = {
    "NetSocket\0\0int\0data\0serialize(QString)\0"
};
...
void NetSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->serialize((*reinterpret_cast< QString(*)>(_a[1])));
